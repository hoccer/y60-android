...
public abstract class GomEntry {
	...
	public abstract JSONObject toJson() throws GomEntryTypeMismatchException,
	...
	public GomAttribute forceAttributeOrException()
		...
		if (this instanceof GomAttribute) {
			...
			throw new GomEntryTypeMismatchException("Entry '" + mPath
					+ "' of repository '" + mProxyHelper.getBaseUri()
					+ "' is not an attribute!");
		}
	}

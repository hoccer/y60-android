...
public class GomNotificationHelperTest extends ActivityUnitTestCase<Y60TestActivity> {
    ...
    //
    // assertTrue("Regular expression should have matched the path",
    ...
    // Pattern.matches(regExp,
    // basePath + ":attribute"));
    // assertFalse("Regular expression shouldnt have matched the path",
    // Pattern.matches(regExp,
    ...
    // br = GomNotificationHelper.registerObserver(attrPath, gomObserver, mGom);
    //
    ...
    // assertEquals("data doesn't match", mJson.toString(),
    // gomObserver.getData().toString());
    // }
    //
    ...
    // String attrPath = testPath + ":" + timestamp;
    // String observerUri = Constants.Gom.URI +
    // GomNotificationHelper.getObserverPathFor(attrPath);
    //
    // try {
    //
    // HttpHelper.get(observerUri);
    // fail("Expected a 404 on observer " + observerUri +
    ...
    // }
    //
    // GomNotificationHelper.registerObserver(attrPath, mMockGomObserver, mGom);
    //
    ...
    // }
    //
    // GomNotificationHelper.registerObserver(nodePath, mMockGomObserver, mGom);
    //
    // // check that the observer has arrived in gom
    // assertNotNull("missing observer in GOM", HttpHelper.get(observerUri));
    // }
    ...
    // String nodePath = testPath + "/" + timestamp;
    // String observerUrl = Constants.Gom.URI +
    // GomNotificationHelper.getObserverPathFor(nodePath);
    //
    // try {
    //
    // HttpHelper.get(observerUrl);
    // fail("Expected a 404 on observer " + observerUrl +
    // ", which shouldn't exist");
    //
    // } catch (Exception ex) {
    //
    ...
    // assertNotNull("missing node in GOM", HttpHelper.get(Constants.Gom.URI +
    // nodePath));
    //
    ...
    // assertEquals("Observer node should be named like the observer id",
    // GomNotificationHelper

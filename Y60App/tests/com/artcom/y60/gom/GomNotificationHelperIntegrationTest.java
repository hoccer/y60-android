...
public class GomNotificationHelperIntegrationTest extends Y60ActivityInstrumentationTest<Y60TestActivity> {
    ...
    public void testRegExpConstraintOnObserver() throws Exception{
        ...
        StatusLine statusLine = HTTPHelper.putUrlEncoded(Constants.Gom.URI+invisibleNodePath, formData);

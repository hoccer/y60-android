...
public class Duration implements java.io.Serializable {
     ...
     * @param aSeconds
     */
    public Duration(boolean negative, int aYears, int aMonths, int aDays, int aHours, int aMinutes,
            double aSeconds) {
        isNegative = negative;
        years = aYears;
        months = aMonths;
     ...
     * its string representation. Hence, a duration object representing 65
     * minutes is considered equal to a duration object representing 1 hour and
     * 5 minutes.
     * 
     * @param object
     */

...
public class Messages {
    ...
    private static final ResourceBundle parent        = (MessagesConstants.rootPackageName == packageName) ? null
                                                              : MessagesConstants.rootBundle;

    /***** NO NEED TO CHANGE ANYTHING BELOW *****/

    private static final MessageBundle  messageBundle = new MessageBundle(projectName, packageName,
                                                              resourceName, locale, classLoader,
                                                              parent);
     ...
     * 
     * @param caller
     *            The calling object, used to get the package name and class
     *            loader
     * @param locale
     *            The locale
     * @param key

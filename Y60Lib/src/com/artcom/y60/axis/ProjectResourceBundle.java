 ...
 * strings, which are the only types of resources available. Property files can
 * inherit properties from other files so that a base property file can be used
 * and a small number of properties can be over-ridden by another property file.
 * For example you may create an english version of a resource file named
 * "resource.properties". You then decide that the British English version of
 * all of the properties except one are the same, so there is no need to
 * redefine all of the properties in "resource_en_GB", just the one that is
 * different.
 * </p>
 * <p>
...
public class ProjectResourceBundle extends ResourceBundle {
    ...
    protected Object handleGetObject(String key) throws MissingResourceException {
        ...
        try {
            ...
            /*
             * catch missing resource, ignore, & return null if this method
             * doesn't return null, then parents are not searched
             */
            obj = null;
        }
        return obj;
     ...
     * 
     * @param projectName
     *            The name of the project to which the class belongs. It must be
     *            a proper prefix of the caller's package.
     * 
     * @param caller
     *            The calling class. This is used to get the package name to
     *            further construct the basename as well as to get the proper
     *            ClassLoader.
     * 
     * @param resourceName
     *            The name of the resource without the ".properties" extension
     * 
     * @throws MissingResourceException
     *             if projectName is not a prefix of the caller's package name,
     *             or if the resource could not be found/loaded.
     */
    public static ProjectResourceBundle getBundle(String projectName, String packageName,
     ...
     *             or if the resource could not be found/loaded.
     */
    public static ProjectResourceBundle getBundle(String projectName, Class caller,
     ...
     */
    public static ProjectResourceBundle getBundle(String projectName, String packageName,
            String resourceName, Locale locale, ClassLoader loader) throws MissingResourceException {
     ...
     * 
     * @param extendsBundle
     *            If non-null, then this ExtendMessages will default to
     *            extendsBundle.
     * 
     * @throws MissingResourceException
     *             if projectName is not a prefix of the caller's package name,
     ...
     */
    public static ProjectResourceBundle getBundle(String projectName, Class caller,
            String resourceName, Locale locale, ResourceBundle extendsBundle)
            throws MissingResourceException {
        return getBundle(projectName, getPackage(caller.getClass().getName()), resourceName,
                locale, caller.getClass().getClassLoader(), extendsBundle);
    }
     ...
     */
    public static ProjectResourceBundle getBundle(String projectName, String packageName,
            String resourceName, Locale locale, ClassLoader loader, ResourceBundle extendsBundle)
            throws MissingResourceException {
        ...
        if (bundle == null) {
            throw new MissingResourceException("Cannot find resource '" + packageName + '.'
    ...
    /**
     * get bundle... - check cache - try up hierarchy - if at top of hierarchy,
     * use (link to) context.getParentBundle()
     */
    ...
    private static class Context {
        ...
        void setLocale(Locale l) {
            /*
             * 1. Docs indicate that if locale is not specified, then the
             * default local is used in it's place. 2. A null value for locale
             * is invalid.
             * 
             * Therefore, default...
             */
        ...
        ResourceBundle loadBundle(String packageName) {
            try {
                return ResourceBundle
                        .getBundle(packageName + '.' + _resourceName, _locale, _loader);
            } catch (MissingResourceException e) {
                // Deliberately surpressing print stack.. just the string for
                // info.
            }
            return null;
        }
        ...
        String validate(String packageName) throws MissingResourceException {
            ...
            /*
             * Ensure that project is a proper prefix of class. Terminate
             * project name with '.' to ensure proper match.
             */
            if (packageName != _projectName && !packageName.startsWith(_projectName + '.')) {
                throw new MissingResourceException("Project '" + _projectName
                        + "' must be a prefix of Package '" + packageName + "'", packageName + '.'
                        + _resourceName, "");
            }

...
public class IntentExtraKeys {
    ...
    public static final String SEARCH_ARGUMENTS         = "arguments";
    ...
    public static final String QUESTION_ACTION_A        = "actiona";
    public static final String QUESTION_ACTION_B        = "actionb";
    ...
    public static final String FOLLOW_UP_ACTION         = "follow_up_action";

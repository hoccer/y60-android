 ...
 * <p>
 * NanoHTTPD version 1.12, Copyright &copy; 2001,2005-2010 Jarno Elonen (elonen@iki.fi,
 * http://iki.fi/elonen/)
 * <p>
...
public class NanoHTTPD {
    ...
    /**
     * Quits the server and blocks until socket is available again
     */
    ...
    private class HTTPSession implements Runnable {
         ...
         * doesn't support multiple identical keys due to the simplicity of Properties -- if you
         * need multiples, you might want to replace the Properties with a Hastable of Vectors or
         * such.
         */
        ...
        /**
         * Returns an error message as a HTTP response and throws InterruptedException to stop
         * furhter request processing.
         */
    ...
    private HTTPSession myHttpSession  = null;
    File                myFileDir;

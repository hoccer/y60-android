 ...
 * broadcasts. Activities can register listeners to this helper for
 * particular URI which they are interested in.
 * 
 * @author arne
...
public class HttpProxyHelper {
    ...
    /**
     * Handler for resource updates, which are received as broadcasts
     * from the HttpProxy
     */
    private Map<URI, Set<ResourceChangeListener>> mListeners;
    
    /**
     * Thread for dispatching incoming broadcasts to the resource update
     * handler
     */
    ...
    public HttpProxyHelper(Context pContext, HttpProxyServiceBindingListener pBindingListener) {
        ...
        mContext.registerReceiver(new HttpResourceUpdateReceiver(),
                                   new IntentFilter(HttpProxyConstants.RESOURCE_UPDATE_ACTION));
